...
//     return {
//         results: wrapPromise(resultsPromise)
//     }
// }
...
const resource = fetchData('/results');
...
function Service1Results() {
    ...
    function typeParser(type) {
        if (type === "credit") { return "신용카드" }
        else if (type === "check") { return "체크카드" }
        else if (type === "hybrid") { return "하이브리드 카드" }
    }
